import 'package:fake_store/core/font_icon/icon_broken.dart';
...
class DeliveryAddressWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
      Text(getTranslated(context, "DeliveryAddressWidget_page_text_delivery_key")),
      const SizedBox(height: 15,),
        ...
        Column(
          ...
          Text("Syria",style: TextStyle(color: Colors.grey),),
        ],),
          const Spacer(),
